...
Compiled 2026-09-21 on `main` at `97dbe65`. Revised the same day after external-review preparation: JMLSG read gaps closed, regulation 31 reading corrected (section A4), 51B and PRIN 2A scoping tightened (sections C3, D1). Ledger pre-flight `python scripts/check_ledger_base.py` passed (593 of 593 claimIds present) before work started. No ledger entries have been created. No prose has been drafted.
...
- REVIEW (priority): the two readings above, tested against the regulation 3(1) definition, regulation 28(1), regulation 31(1) and the 51C(a) phrasing.
