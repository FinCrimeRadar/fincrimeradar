...
- **Stablecoin Guide 1: UK Stablecoin Regulation 2026. Status: BLOCKED.** Guides 0, 2, 3, 4 and 5 are live. Guide 1 still depends on the FCA's final cryptoasset perimeter guidance, including PERG 19 treatment of overseas issuance. FCA material checked on 14 September 2026 still described CP26/13 as consultation guidance and said final perimeter guidance would be published in autumn or September 2026. Re-check when the final publication appears, no later than the 30 September 2026 authorisation-window opening.
